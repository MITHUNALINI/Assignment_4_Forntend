              ...
              <CardContent>
                ...
                <ValidatorForm onSubmit={this.handleLogin} >
                  <Grid container spacing={1}>
                      <Grid item xs={11}>
                        <strong>
                       <h1 style={{color:"blue",fontFamily: 'Raleway',fontSize:40,marginLeft:10}}>Login to Books Shop</h1>
                       </strong>
                      </Grid>
                      <Grid item xs={12}>
                        <FormControl >
                         <TextValidator  style={{width:250,marginLeft:10} }
                          type="text" 
                      ...
                      <Grid item xs={12} >
                        <FormControl>
                          <button style={{backgroundColor:"blue",marginLeft:10,fontSize:"20px"}}>Login</button>
                        </FormControl>
                      </Grid>
                  </Grid>
                </ValidatorForm>
