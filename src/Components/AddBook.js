...
export default class AddBook extends Component {
  ...
  handleAddBook = (event) => {
    ...
    if (this.state.title && this.state.author && this.state.url && this.state.isbn && this.state.price && this.state.language && this.state.genre) {
      this.setState({
        successful: true,
        ...
        <Grid item xs={5} style={{backgroundColor:"black"}}>
          <Card className={style.root} style={{margin:20}}>
           ...
           <Paper variant="outlined">
             <form className={style.root} noValidate autoComplete="off" style={{width:'150%'}}onSubmit={this.handleAddBook}>
             ...
             <Grid container spacing={1}>
                      ...
                      <Grid item xs={12}>
                        ...
                        <Button  href=""variant="contained" onClick={this.reset} style={{backgroundColor:'#0d47a1'}}> <ReplayIcon style={{fontSize:20}}/>RESET</Button>&emsp; &emsp; 
